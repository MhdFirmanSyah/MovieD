...
const SliderGlimmer = () => {
  ...
  return (
    // container
    <div className="slider-container loading bg-[#ffff] dark:bg-[#1c1c1c]  justify-center w-full h-96 md:h-[25rem] lg:h-[500px] xl:h-[580px] 2xl:h-[700px] flex relative  bg-center sm:justify-normal">
      {/* img/poster */}
      ...
      <div className="info-container container m-auto absolute sm:bottom-[10vw] bottom-[5vw] md:bottom-[5vw] xl:bottom-[9vw] 2xl:bottom-[6vw] lg:bottom-[8vw] xl:m-auto sm:left-[37vw] md:left-[20rem] 2xl:left-[42rem] lg:left-[25rem] xl:left-[30rem] justify-center items-center content-center sm:content-start sm:items-start sm:justify-start mx-auto flex flex-col gap-2 md:gap-3 ">
        ...
        <section className="overview-skeleton flex z-50 gap-2 sm:flex-col flex-row">
          ...
          <span className="rating-bar side-about sm:hidden  shadow-none">
            Rating
          </span>
          <span className="info-icon side-about sm:hidden order-last  shadow-none">
            Media
          </span>
          {/* <div className="info-icon"> lorem</div> */}
          <div className="flex flex-row w-max py-1 px-3 rounded-lg m-auto sm:m-0 content-center justify-center gap-2 items-center backdrop-blur-lg bg-white/25 dark:bg-black/25 drop-shadow-[-5px_-5px_3px_rgba(0,0,0,1)] z-50 ">
            ...
            <span className="w-[20px] size-5 bg-black  rounded-full  " />
          </div>
        </section>
      </div>
    </div>
